...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-09-2016 a las 17:39:39
...
(2, NULL, NULL, 8, 'asdas', 'asdfasd', '12312', 12312, 12123, 1212, 1, NULL, '2016-09-22 19:08:25'),
(3, NULL, NULL, 8, 'asdf', 'asdasd', '121', 123, 11, 1, 1, NULL, '2016-09-22 19:08:52'),
(4, NULL, NULL, 8, 'asdf', 'asdf', '123', 123, 1212, 1, 1, NULL, '2016-09-22 19:09:02'),
(5, NULL, NULL, 8, 'asdf', 'sdf', '121', 1212, 121212, 12, 1, NULL, '2016-09-22 19:09:38'),
(6, NULL, NULL, 8, 'asd', 'asd', '12', 1, 1, 1, 1, NULL, '2016-09-22 19:10:15'),
(7, NULL, NULL, 8, 'asd', 'asd', '1', 1, 1, 1, 1, NULL, '2016-09-22 19:10:29'),
(8, NULL, NULL, 8, 'asd', 'asdas', '1212', 1, 1, 1, 1, NULL, '2016-09-22 19:10:53'),
(9, NULL, NULL, 8, 'asdfasd', 'asd', '234', 234, 23, 23, 1, NULL, '2016-09-22 19:11:04'),
(10, NULL, NULL, 8, 'asd', 'as', '1', 11, 1, 1, 1, NULL, '2016-09-22 19:11:28');
...
(10, 1, 9, NULL, 8, 0, '3314548', '50000', '20000', '290000', NULL, 1, NULL, '2016-08-10 16:59:00', '2016-08-10 00:00:00');
...
`id` int(11) NOT NULL,
  ...
  `usuario_modificacion_id` int(11) DEFAULT NULL,
  `usuario_creacion_id` int(11) DEFAULT NULL,
  `valoracion_inicial` int(11) DEFAULT NULL,
  `valoracion_final` int(11) DEFAULT NULL,
  `active` tinyint(1) NOT NULL,
  `fecha_modificacion` datetime DEFAULT NULL,
  `fecha_creacion` datetime NOT NULL
...
--
-- Volcado de datos para la tabla `asignacion_beneficiario_programa_capacitacion_financiera`
--

INSERT INTO `asignacion_beneficiario_programa_capacitacion_financiera` (`id`, `programa_capacitacion_financiera_id`, `beneficiario_id`, `participante_id`, `usuario_modificacion_id`, `usuario_creacion_id`, `valoracion_inicial`, `valoracion_final`, `active`, `fecha_modificacion`, `fecha_creacion`) VALUES
(3, 1, 3, NULL, NULL, 8, NULL, NULL, 1, NULL, '2016-08-11 23:16:47'),
(7, 1, 2, 1, NULL, 8, NULL, NULL, 1, NULL, '2016-08-16 22:51:41'),
(9, 1, 4, 2, NULL, 8, NULL, NULL, 1, NULL, '2016-08-17 19:32:52'),
(10, 1, 5, NULL, NULL, 8, NULL, NULL, 1, NULL, '2016-08-17 21:32:26'),
(11, 3, 2, NULL, NULL, 8, NULL, NULL, 1, NULL, '2016-09-20 18:07:25'),
(13, 3, 3, 2, NULL, 8, NULL, NULL, 1, NULL, '2016-09-20 18:08:48');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `asignacion_beneficiario_ruta_financiera`
--

CREATE TABLE IF NOT EXISTS `asignacion_beneficiario_ruta_financiera` (
`id` int(11) NOT NULL,
  `programa_capacitacion_financiera_id` int(11) DEFAULT NULL,
  `beneficiario_id` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `asignacion_municipio_municipio`
--

CREATE TABLE IF NOT EXISTS `asignacion_municipio_municipio` (
`id` int(11) NOT NULL,
  `programa_capacitacion_financiera_id` int(11) DEFAULT NULL,
  `municipio_seleccionado_id` int(11) DEFAULT NULL,
  `municipio_asignado_id` int(11) DEFAULT NULL,
  `usuario_modificacion_id` int(11) DEFAULT NULL,
  `usuario_creacion_id` int(11) DEFAULT NULL,
  `active` tinyint(1) NOT NULL,
  `fecha_modificacion` datetime DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `asignacion_municipio_municipio`
--

INSERT INTO `asignacion_municipio_municipio` (`id`, `programa_capacitacion_financiera_id`, `municipio_seleccionado_id`, `municipio_asignado_id`, `usuario_modificacion_id`, `usuario_creacion_id`, `active`, `fecha_modificacion`, `fecha_creacion`) VALUES
(2, 1, 1, 2, NULL, 8, 1, NULL, '2016-09-15 23:29:43'),
(4, 1, 2, 4, NULL, 8, 1, NULL, '2016-09-23 17:01:37');
...
(60, 1, 7, NULL, 8, '2016-08-11 00:00:00', NULL, '5000', '10000', NULL, '50', 1, NULL, '2016-08-10 16:38:29', '5000', '5000'),
(61, 1, 7, NULL, 8, '2016-10-15 00:00:00', NULL, '20000', '15000', NULL, '67', 1, NULL, '2016-08-10 16:39:40', '0', '10000'),
(64, 1, 7, NULL, 8, '2016-12-15 00:00:00', NULL, '25000', '10000', NULL, '50', 1, NULL, '2016-08-10 16:42:16', '0', '5000');
...
(1, 1, 169, NULL, 8, 1, '2016-08-11 00:00:00', 1, NULL, '2016-08-10 19:10:05'),
(3, 2, 169, NULL, 8, 1, '2016-08-11 00:00:00', 1, NULL, '2016-08-11 22:54:27');
...
(15, 96, NULL, 8, '2016-09-22 00:00:00', '2016-09-30 00:00:00', 'Un Lugar', 1, NULL, '2016-09-22 19:05:46');
...
(1, NULL, 1, 6, 45, 50, 215, 11, 221, 18, 28, 34, 218, 8, NULL, 2, '1321357', 'Cantor', 'Pajarito', 'Sebastian', 'Juan', '2013-02-06 00:00:00', 3, NULL, 1, 1, 0, '24749447', '3101341848', 'correo@prueba.com', 1, '2016-08-18 17:02:20', '2016-07-12 17:42:23'),
(2, NULL, 4, 6, 46, 50, 215, 8, 221, 17, 28, 34, 37, NULL, 8, 2, '12485401', 'Bastidas', 'Aponte', 'Carlos', 'Daniel', '2016-02-17 00:00:00', 10, NULL, 0, 0, 0, '1548540', '14411517', 'correo@prueba.com', 1, NULL, '2016-08-16 22:33:03'),
(5, NULL, 1, 6, 45, 50, 213, 8, 221, 219, 28, 34, 37, NULL, 8, NULL, '1241171', 'Daniel', NULL, 'Bastidas', NULL, '2016-01-20 00:00:00', 14, NULL, 0, 0, 0, NULL, NULL, NULL, 1, NULL, '2016-08-17 19:32:36');
...
(1, 1, 169, 16, NULL, 8, 'El Salón Comunal de Doña Pepa', 1, NULL, '2016-08-10 19:09:12'),
(2, 1, 169, 18, NULL, 8, 'Narnia', 1, NULL, '2016-08-11 18:20:02');
...
(8, '$2y$13$896qxybdoaskck80kk44oetX8FUhdHfNiOo3IRIdyAXR65FzuAEZG', '896qxybdoaskck80kk44ogowg44g400', '654364634', '5464564', 'coordinador@correo.com', 1, NULL, '2016-05-06 13:51:46', 1, NULL, NULL, 'coordinador', 'coordinador', 'coordinador@correo.com', 'coordinador@correo.com', 1, '2016-09-19 16:54:29', 0, 0, NULL, NULL, NULL, 'a:1:{s:5:"admin";s:10:"ROLE_ADMIN";}', 0, NULL, '435452', 'coordinador', 'coordinador', 'coordinador', 'coordinador', 47),
...
--
-- Indices de la tabla `asignacion_beneficiario_ruta_financiera`
--
ALTER TABLE `asignacion_beneficiario_ruta_financiera`
 ADD PRIMARY KEY (`id`), ADD KEY `IDX_85C27DEE6B25D3FE` (`programa_capacitacion_financiera_id`), ADD KEY `IDX_85C27DEE4B64ABC7` (`beneficiario_id`), ADD KEY `IDX_85C27DEE58BC1BE0` (`municipio_id`), ADD KEY `IDX_85C27DEEF6F50196` (`participante_id`), ADD KEY `IDX_85C27DEEDADD026` (`usuario_modificacion_id`), ADD KEY `IDX_85C27DEEAEADF654` (`usuario_creacion_id`);
...
--
-- Indices de la tabla `asignacion_municipio_municipio`
--
ALTER TABLE `asignacion_municipio_municipio`
 ADD PRIMARY KEY (`id`), ADD KEY `IDX_838FE0196B25D3FE` (`programa_capacitacion_financiera_id`), ADD KEY `IDX_838FE0193DD4AA4C` (`municipio_seleccionado_id`), ADD KEY `IDX_838FE019216F3342` (`municipio_asignado_id`), ADD KEY `IDX_838FE019DADD026` (`usuario_modificacion_id`), ADD KEY `IDX_838FE019AEADF654` (`usuario_creacion_id`);
...
--
-- AUTO_INCREMENT de la tabla `asignacion_beneficiario_ruta_financiera`
--
ALTER TABLE `asignacion_beneficiario_ruta_financiera`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `asignacion_municipio_municipio`
--
ALTER TABLE `asignacion_municipio_municipio`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
ADD CONSTRAINT `FK_D8FF37416B25D3FE` FOREIGN KEY (`programa_capacitacion_financiera_id`) REFERENCES `capacitacion_financiera` (`id`),
...
--
-- Filtros para la tabla `asignacion_beneficiario_ruta_financiera`
--
ALTER TABLE `asignacion_beneficiario_ruta_financiera`
ADD CONSTRAINT `FK_85C27DEE4B64ABC7` FOREIGN KEY (`beneficiario_id`) REFERENCES `beneficiario` (`id`),
ADD CONSTRAINT `FK_85C27DEE58BC1BE0` FOREIGN KEY (`municipio_id`) REFERENCES `municipio` (`id`),
ADD CONSTRAINT `FK_85C27DEE6B25D3FE` FOREIGN KEY (`programa_capacitacion_financiera_id`) REFERENCES `programa_capacitacion_financiera` (`id`),
ADD CONSTRAINT `FK_85C27DEEAEADF654` FOREIGN KEY (`usuario_creacion_id`) REFERENCES `usuario` (`id`),
ADD CONSTRAINT `FK_85C27DEEDADD026` FOREIGN KEY (`usuario_modificacion_id`) REFERENCES `usuario` (`id`),
ADD CONSTRAINT `FK_85C27DEEF6F50196` FOREIGN KEY (`participante_id`) REFERENCES `participante` (`id`);
...
--
-- Filtros para la tabla `asignacion_municipio_municipio`
--
ALTER TABLE `asignacion_municipio_municipio`
ADD CONSTRAINT `FK_838FE019216F3342` FOREIGN KEY (`municipio_asignado_id`) REFERENCES `municipio` (`id`),
ADD CONSTRAINT `FK_838FE0193DD4AA4C` FOREIGN KEY (`municipio_seleccionado_id`) REFERENCES `municipio` (`id`),
ADD CONSTRAINT `FK_838FE0196B25D3FE` FOREIGN KEY (`programa_capacitacion_financiera_id`) REFERENCES `programa_capacitacion_financiera` (`id`),
ADD CONSTRAINT `FK_838FE019AEADF654` FOREIGN KEY (`usuario_creacion_id`) REFERENCES `usuario` (`id`),
ADD CONSTRAINT `FK_838FE019DADD026` FOREIGN KEY (`usuario_modificacion_id`) REFERENCES `usuario` (`id`);
