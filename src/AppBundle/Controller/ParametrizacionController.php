...
class ParametrizacionController extends Controller
{
    ...
    /**
     * @Route("/backend/permiso-rol/asignar/{idUsuario}", name="asignarPermisoRol")
     */
    public function asignarPermisoRolAction($idUsuario)
    {

        return $this->render(
        	'AppBundle:Backend/Parametrizacion:permiso-rol-asignar.html.twig' 
        );
    }

    /**
     * @Route("/backend/permiso-rol/editar/{idUsuario}", name="editarPermisoRol")
     */
    public function editarPermisoRolAction($idUsuario)
    {
    ...
    /**
     * @Route("/backend/permiso-rol/gestion/{idUsuario}", name="gestionPermisoRol")
     */
    public function gestionPermisoRolAction()
    {
