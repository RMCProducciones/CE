...
/**
 * AsignacionGrupoConcurso
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Entity\AsignacionGrupoConcursoRepository")
 */
class AsignacionGrupoConcurso
{
    /**
     * @var integer
     *
     ...
     *
     * @return AsignacionGrupoConcurso
     */
