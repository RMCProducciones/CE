...
/**
 * AsignacionBeneficiarioEstructuraOrganizacional
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Entity\AsignacionBeneficiarioEstructuraOrganizacionalRepository")
 */
class AsignacionBeneficiarioEstructuraOrganizacional
{
    /**
     * @var integer
     *
     ...
     *
     * @return AsignacionBeneficiarioEstructuraOrganizacional
     */
