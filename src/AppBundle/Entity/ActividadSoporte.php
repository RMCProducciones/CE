 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Entity\ActividadSoporteRepository")
 * @ORM\HasLifecycleCallbacks
 */
class ActividadSoporte
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\ActividadConcurso")
     */
    private $actividad;
     ...
     * Set actividad
     *
     * @param AppBundle\Entity\ActividadConcurso $actividad
     *
     * @return ActividadConcursoSoporte
     */
    public function setActividadConcurso(\AppBundle\Entity\ActividadConcurso $actividad)
    {
     ...
     * Get actividad
     *
     * @return AppBundle\Entity\ActividadConcurso
     */
    public function getActividadConcurso()
    {
