...
/**
 * CapacitacionFinancieraSoporte
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Entity\CapacitacionFinancieraSoporteRepository")
 * @ORM\HasLifecycleCallbacks
 */
class CapacitacionFinancieraSoporte
{
    /**
     * @var integer
     *
     ...
     */
    private $capacitacionFinanciera;
    ...
    /**
     * Set capacitacionFinanciera
     *
     * @param AppBundle\Entity\CapacitacionFinanciera $capacitacionFinanciera
     *
     * @return CapacitacionFinancieraSoporte
     */
    public function setCapacitacionFinanciera(\AppBundle\Entity\CapacitacionFinanciera $capacitacionFinanciera)
    {
        $this->capacitacionFinanciera = $capacitacionFinanciera;
    
        return $this;
    }

    /**
     * Get capacitacionFinanciera
     *
     * @return AppBundle\Entity\CapacitacionFinanciera
     */
    public function getCapacitacionFinanciera()
    {
        return $this->capacitacionFinanciera;
    }
