...
/**
 * SeguimientoGrupoSoporte
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Entity\SeguimientoGrupoSoporteRepository")
 * @ORM\HasLifecycleCallbacks
 */
class SeguimientoGrupoSoporte
{
    /**
     * @var integer
     *
     ...
     *
     * @return SeguimientoGrupoSoporte
     */
