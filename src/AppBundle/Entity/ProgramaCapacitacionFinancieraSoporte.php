...
/**
 * ProgramaCapacitacionFinancieraSoporte
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Entity\ProgramaCapacitacionFinancieraSoporteRepository")
 * @ORM\HasLifecycleCallbacks
 */
class ProgramaCapacitacionFinancieraSoporte
{
    /**
     * @var integer
     *
     ...
     *
     * @return ProgramaCapacitacionFinancieraSoporte
     */
