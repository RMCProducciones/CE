...
/**
 * ExperienciaExitosaSoporte
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Entity\ExperienciaExitosaSoporteRepository")
 * @ORM\HasLifecycleCallbacks
 */
class ExperienciaExitosaSoporte
{
    /**
     * @var integer
     *
     ...
     *
     * @return ExperienciaExitosaSoporte
     */
