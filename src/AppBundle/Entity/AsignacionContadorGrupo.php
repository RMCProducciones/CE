...
/**
 * AsignacionContadorGrupo
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="AppBundle\Entity\AsignacionContadorGrupoRepository")
 */
class AsignacionContadorGrupo
{
    /**
     * @var integer
     *
     ...
     *
     * @return AsignacionContadorGrupo
     */
