...
php app/console doctrine:generate:entity --entity="AppBundle:DistribucionPremio" --fields="concurso:integer grupo:integer posicion:integer valor:decimal active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"
...
php app/console doctrine:generate:entity --entity="AppBundle:ProgramaCapacitacionFinanciera" --fields="talento_financiero:integer estado:integer municipio:integer lugar:string active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"

php app/console doctrine:generate:entity --entity="AppBundle:CapacitacionFinanciera" --fields="programaCapacitacionFinanciera:integer modulo:integer estado:integer fecha:datetime active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"

php app/console doctrine:generate:entity --entity="AppBundle:AsignacionBeneficiarioProgramaCapacitacionFinanciera" --fields="programaCapacitacionFinanciera:integer beneficiario:integer participante:integer valoracion_inicial:integer valoracion_final:integer active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"
...
php app/console doctrine:generate:entity --entity="AppBundle:Organizacion" --fields=" nombre_organizacion:string  linea_productiva:string tipo_producto:string fecha_inscripcion:datetime codigo:string nombre:string direccion:string rural:boolean barrio:string corregimiento:string vereda:string cacerio:string municipio:integer tipo_documentoo_contacto:integer numero_documento_contacto:string primer_apellidoo_contacto:string segundo_apellidoo_contacto:string primer_nombreo_contacto:string segundo_nombreo_contacto:string telefono_fijoo_contacto:string telefono_celularo_contacto:string correo_electronicoo_contacto:string ruta:boolean pasantia:boolean observaciones:string active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"

php app/console doctrine:generate:entity --entity="AppBundle:TerritorioAprendizaje" --fields=" nombre_territorio:string  observaciones:string active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"

php app/console doctrine:generate:entity --entity="AppBundle:OrganizacionTerritorioAprendizaje" --fields=" territorio_aprendizaje:string  organizacion:string active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"

php app/console doctrine:generate:entity --entity="AppBundle:Ruta" --fields=" territorio_aprendizaje:string  grupo:string nombre_ruta:string observaciones:string active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"

php app/console doctrine:generate:entity --entity="AppBundle:OrganizacionRuta" --fields=" ruta:string  organizacion:string active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"

php app/console doctrine:generate:entity --entity="AppBundle:BeneficiarioRuta" --fields=" ruta:string  beneficiario:string active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"
...
php app/console doctrine:generate:entity --entity="AppBundle:DiagnosticoOrganizacional" --fields="grupo:integer fecha_visita:datetime promotor:integer productiva-a:smallint productiva-b:smallint productiva-c:smallint productiva-d:smallint productiva-e:smallint productiva-f:smallint comercial-a:smallint comercial-b:smallint comercial-c:smallint comercial-d:smallint comercial-e:smallint financiera-a:smallint financiera-b:smallint financiera-c:smallint financiera-d:smallint financiera-e:smallint financiera-f:smallint administrativa-a:smallint administrativa-b:smallint administrativa-c:smallint administrativa-d:smallint administrativa-e:smallint organizacional-a:smallint organizacional-b:smallint organizacional-c:smallint organizacional-d:smallint organizacional-e:smallint organizacional-f:smallint totalProductiva:smallint totalComercial:smallint totalFinanciera:smallint totalAdministrativa:smallint totalOrganizacional:smallint total:smallint active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"
...
php app/console doctrine:generate:entity --entity="AppBundle:Taller" --fields="grupo:integer fecha:datetime objetivo:text agenda:text lugar:text asistentes:integer observaciones:text compromisos:text active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"

php app/console doctrine:generate:entity --entity="AppBundle:AsignacionBeneficiarioTaller" --fields="taller:integer beneficiario:integer active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"


php app/console doctrine:generate:entity --entity="AppBundle:Visita" --fields="seguimientoFase:integer fecha:datetime objetivo:text agenda:text lugar:text asistentes:integer comite_compras:boolean funcionamiento_comite_compras:integer comite_vamos_bien:boolean funcionamiento_comite_vamos_bien:integer logros_compras:text logros_vamos_bien:text contador:boolean desempeno_contador:integer observaciones_contador:text observaciones_presupuesto_asignado:text cambios_presupuesto_asignado:boolean cambios_razones_presupuesto_asignado:text desempeno_organizacional:text desempeno_productivo:text desempeno_comercial:text desempeno_administrativo:text desempeno_financiero:text cambios_integrantes_grupo:boolean cambios_razones_integrantes_grupo:text observaciones:text compromisos:text interventoria:boolean razones_interventoria:text active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"
...
php app/console doctrine:generate:entity --entity="AppBundle:Nodo" --fields="nombre:string fase:integer formal:boolean negocio:boolean active:boolean usuario_modificacion:integer fecha_modificacion:datetime usuario_creacion:integer fecha_creacion:datetime"
